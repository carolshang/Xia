...
public class GetTestData {
    ...
    public List<Person> getTestData(){
        ...
        String filepath = "/Users/carol/Desktop/数据挖掘/数据仓库第二次作业2016/任务一/adult.test.txt";
        ...
        try{
            ...
            if (file.isFile() && file.exists()){
               ...
               /* for (Person p : personlist){
                ...
                System.out.println("Can't find test data files!");
            }
        }
        catch (Exception e){
            System.out.println("Fail to read test data file!");
            e.printStackTrace();
        }
